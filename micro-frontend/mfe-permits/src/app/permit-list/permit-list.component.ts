  ...
  template: `
    <div class="mfe-container">
      <div class="page-header">
        <div>
          <h2>E-Permits</h2>
          <p class="subtitle">Manage permit applications</p>
        </div>
...
export class PermitListComponent implements OnInit, AfterViewInit {
  ...
  loadData(): void {
    ...
    this.http.get<any>('http://localhost:8000/api/permits', { headers }).subscribe({
      next: (res) => {
